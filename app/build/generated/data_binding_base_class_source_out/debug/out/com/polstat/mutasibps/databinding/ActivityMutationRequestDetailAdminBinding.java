...
public final class ActivityMutationRequestDetailAdminBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMutationRequestDetailAdminBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton backButton, @NonNull MaterialButton btnUpdateStatus,
      ...
      @NonNull TextView headerText, @NonNull Spinner spinnerStatus, @NonNull CardView statusCard,
      @NonNull TextView tvJabatanSekarang, @NonNull TextView tvJabatanTujuan,
      @NonNull TextView tvKabupatenTujuan, @NonNull TextView tvNama, @NonNull TextView tvNip,
      @NonNull TextView tvProvinsiTujuan, @NonNull TextView tvStatusLabel,
      @NonNull TextView tvTitleAjuan, @NonNull TextView tvTitleIdentitas,
      @NonNull TextView tvUnitKerjaSekarang, @NonNull TextView tvUnitKerjaTujuan) {
  ...
  @NonNull
  public static ActivityMutationRequestDetailAdminBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ActivityMutationRequestDetailAdminBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.activity_mutation_request_detail_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMutationRequestDetailAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMutationRequestDetailAdminBinding((ConstraintLayout) rootView, backButton,
          btnUpdateStatus, buttonContainer, cardAjuanMutasi, cardIdentitas, headerContainer,
          headerText, spinnerStatus, statusCard, tvJabatanSekarang, tvJabatanTujuan,
          tvKabupatenTujuan, tvNama, tvNip, tvProvinsiTujuan, tvStatusLabel, tvTitleAjuan,
          tvTitleIdentitas, tvUnitKerjaSekarang, tvUnitKerjaTujuan);
    }
